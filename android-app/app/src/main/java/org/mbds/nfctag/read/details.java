...
TextView mat , ip  ; TextView justi  ; TextView matiere , nbabs , heure   , link ,link2;
Button send ;
...
nbabs=findViewById(R.id.textView5);
       ...
       matriculeintent= getIntent().getStringExtra("matricule");
        ...
        link2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                swt1();
     //           Toast.makeText(this,""+ matriculeintent.toString(), Toast.LENGTH_LONG).show();
                Intent intent = new Intent(details.this, studentdetails.class);
                intent.putExtra("matricule12", matriculeintent);
    ...
    public void swt1 (){
        startActivity(new Intent(details.this, studentdetails.class));
    ...
    public void readapi (String mat ){
        ...
        if (SDK_INT > 8) {
            ...
            try {
                URL url = new URL("http://192.168.1.103:8081/searchAbsStu?matricule="+mat);
               ...
               matiere1= object.getJSONObject("cour").getJSONObject("matiere").getString("intitule") ;
                        abs = abs+object.getJSONObject("cour").getInt("volume");
...
//                    String mat1 = " " , justif1 = " ", matiere1= " " ;
                    if(justif1.charAt(0)=='f')
                    {
                        justi.setText("Absence non justifié");
                    }
                    else if (justif1.charAt(0)=='t')
                    {
                        justi.setText("Absence justifié");
                    }
                    matiere.setText(matiere1);
                    ip.setText(mat);
heure.setText("Nombre d'absence est "+abs/2+" avec nombre d'heures est "+abs+"heures");
